...
import SuggestGroupDetailPage from "../Community/SuggestDetailPage";

function SuggestGroupDetailPageConstants() {
...
export default SuggestGroupDetailPageConstants;
